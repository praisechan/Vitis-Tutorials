...
#---------------------------
# Platform Parameters for xilinx_u55c_gen3x16_xdma_3_202210_1
#---------------------------
...
#---------------------------
# Instantiating Filter2DKernel_1
#---------------------------
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /Filter2DKernel_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /Filter2DKernel_1/ap_clk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /Filter2DKernel_1/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins -auto_enable /Filter2DKernel_1/interrupt] \
...
hbm_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Filter2DKernel_1/m_axi_gmem1] \
  [get_bd_cells /hmss_0] [list HBM_MEM00]

hbm_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Filter2DKernel_1/m_axi_gmem0] \
  [get_bd_cells /hmss_0] [list HBM_MEM00]
