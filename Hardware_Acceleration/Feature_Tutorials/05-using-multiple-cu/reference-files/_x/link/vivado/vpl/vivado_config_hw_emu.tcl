...
set_property -name {XSIM.COMPILE.XSC.MORE_OPTIONS}  -value { --gcc_compile_options "-I/opt/Xilinx/Vitis_HLS/2022.2/include" --cppversion 14} -objects [current_fileset -simset]
