set moduleName PixelStream2AXIBursts_Pipeline_bytes2aximm
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {PixelStream2AXIBursts_Pipeline_bytes2aximm}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 256 regular {axi_master 1}  }
	{ sext_ln102 int 59 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "coeffs","offset": { "type": "dynamic","port_name": "coeffs","bundle": "control"},"direction": "READONLY"},{"cName": "dst","offset": { "type": "dynamic","port_name": "dst","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln102", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln102 sc_in sc_lv 59 signal 1 } 
	{ loopWidth sc_in sc_lv 12 signal 2 } 
	{ buff_V_address0 sc_out sc_lv 6 signal 3 } 
	{ buff_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ buff_V_q0 sc_in sc_lv 256 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln102", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln102", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "2051"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "2051"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln102 { ap_none {  { sext_ln102 in_data 0 59 } } }
	loopWidth { ap_none {  { loopWidth in_data 0 12 } } }
	buff_V { ap_memory {  { buff_V_address0 mem_address 1 6 }  { buff_V_ce0 mem_ce 1 1 }  { buff_V_q0 mem_dout 0 256 } } }
}
