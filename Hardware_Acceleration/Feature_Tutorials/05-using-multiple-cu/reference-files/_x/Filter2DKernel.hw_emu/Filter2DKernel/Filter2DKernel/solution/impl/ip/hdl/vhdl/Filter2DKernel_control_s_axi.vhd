...
architecture behave of Filter2DKernel_control_s_axi is
    ...
    constant ADDR_SRC_DATA_0    : INTEGER := 16#1c#;
    constant ADDR_SRC_DATA_1    : INTEGER := 16#20#;
    constant ADDR_SRC_CTRL      : INTEGER := 16#24#;
    ...
    constant ADDR_DST_DATA_0    : INTEGER := 16#40#;
    constant ADDR_DST_DATA_1    : INTEGER := 16#44#;
    constant ADDR_DST_CTRL      : INTEGER := 16#48#;
