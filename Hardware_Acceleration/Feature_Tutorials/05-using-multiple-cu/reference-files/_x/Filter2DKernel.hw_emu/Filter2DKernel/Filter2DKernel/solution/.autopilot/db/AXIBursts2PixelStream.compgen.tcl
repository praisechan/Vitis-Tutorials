...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2DKernel_AXIBursts2PixelStream_buff_V_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stride_c_din { O 32 vector } stride_c_num_data_valid { I 3 vector } stride_c_fifo_cap { I 3 vector } stride_c_full_n { I 1 bit } stride_c_write { O 1 bit } } \
} "
}
